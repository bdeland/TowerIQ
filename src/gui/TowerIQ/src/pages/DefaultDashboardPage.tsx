...
function DefaultDashboardContent() {
  ...
  useEffect(() => {
    ...
    if (isLoading || (currentPanelIds === lastPanelIds && selectedValuesString === lastSelectedValues)) {
      return;
    }
    ...
    fetchAllPanelData();
  }, [selectedValues, dashboard, panels, isLoading, lastPanelIds, lastSelectedValues]);
