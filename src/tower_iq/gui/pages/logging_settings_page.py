"""
TowerIQ Logging Settings Page

This module provides the logging and diagnostics settings content.
"""
...
class LoggingSettingsPage(QWidget):
    """Logging & Diagnostics settings content page."""
    ...
    def setup_ui(self):
        """Set up the logging settings user interface."""
    ...
    def setup_content(self, content_layout: QVBoxLayout):
        ...
        # Use the existing LoggingSettingsWidget
        logging_widget = LoggingSettingsWidget(self.config_manager, self)
